  ...
  build: {
    rollupOptions: {
      input: {
        ...
        tangram: fromRoot('games/tangram/index.html'),
        kakuro: fromRoot('games/kakuro/index.html'),
        gizlinesne: fromRoot('games/gizlinesne/index.html'),
        resimtamamla: fromRoot('games/resimtamamla/index.html'),
        mahjong: fromRoot('games/mahjong/index.html'),
        zuma: fromRoot('games/zuma/index.html'),
        solitaire: fromRoot('games/solitaire/index.html'),
        orumcek: fromRoot('games/orumcek/index.html'),
        freecell: fromRoot('games/freecell/index.html'),
        rubik: fromRoot('games/rubik/index.html'),
      },
    },
  },
})
