...
export default tanim({
  ...
  ipucu:
    '<b>Nereye dokunursan mızrak oraya gider</b> · <kbd>Boşluk</kbd> saldır · <kbd>↑</kbd><kbd>↓</kbd> nişan · <kbd>P</kbd> duraklat · <kbd>E</kbd> element · <kbd>C</kbd> kamera açısı · <kbd>M</kbd> ya da sağ üstteki <b>☰</b> dükkân (açıkken oyun durur) · <b>Yuvaya dokun</b>, sonra alttaki panelden kule kur ya da yükselt · <b>uçan canavara mızrak değmez, yalnız kuleler vurur</b>',
  emoji: '🏯',
  kategori: 'arcade',
