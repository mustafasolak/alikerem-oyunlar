...
export const KAP_GENISLIK = 52
export const KAP_KENAR = 4
export const TOP_YARICAP = 19
export const PARCA_YUKSEKLIK = 40
export const KAP_ALT = 350
...
/** Görsel tema: 'su' katmanlı sıvı, 'top' yuvarlak parça. */
export const TEMA: string = 'top'
